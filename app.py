"""Pass Scout — European leagues position ratings and threat pass maps."""
...
def _player_analysis_options(
    ...
    *,
    ...
    ranked_rows = ranked_rows[:PLAYER_SELECTOR_TOP_N]
...
def render_xp_season_rankings(xp_players: list[dict]) -> None:
    ...
    meta = xe.season_meta()
    st.markdown("### xP M4 — temporada Ligas Europeias")
    st.caption(
...
def render_estudo_section() -> None:
    ...
    st.caption(
        ...
        f"Pool global: Premier League ({meta.get('league_matches_premier_league', '—')}) + "
...
def _player_analysis_mock_inner_html() -> str:
    ...
    return (
        ...
        '<div class="pres-sim-mock-field">Ligas Europeias player · rating profile</div>'
...
def _render_presentation_player_analysis_demo() -> None:
    demo_html = (
        ...
        "<p>Explore any European leagues player with season xP metrics, pillar stats, "
